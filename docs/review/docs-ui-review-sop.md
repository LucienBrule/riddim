...
3. Open pages under `http://localhost:4174/riddim/` (hub) and `http://localhost:4174/riddim/antora/<component>/<version>/...`.
   - Example: `http://localhost:4174/riddim/antora/development/0.1/onboarding.html`.
...
6. Optional sanity checks:
   - `curl -I http://localhost:4174/riddim/`
   - `curl -I http://localhost:4174/riddim/antora/user/0.1/index.html`
